...
class Init(val books:BookRepository, val categories: CategoryRepository) : CommandLineRunner {
    ...
    override fun run(vararg args: String?) {
        val fantasy = CategoryDAO(0, "Fantasy", listOf())
        ...
        fantasy.books = listOf(lor1,lor2,lor3)
...
class Init2(val books:BookRepository, val categories: CategoryRepository) : CommandLineRunner {
    @Transactional
    override fun run(vararg args: String?) {
        val sciencefiction = CategoryDAO(0, "ScienceFiction", listOf())
        ...
        val romance = CategoryDAO(0, "Romance", listOf())
